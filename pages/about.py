...
with col2:
    ...
    **ver. 0.7.4** (06.10)
    ...
    st.markdown("""
    <p>동시에, KSAT Agent는 ChatGPT 등 범용 AI가 달성하기 힘든 높은 수준의 퀄리티를 유지합니다. Multi-Agent 시스템과 Fine-tuning된 전용 AI 모델을 구축하는 등 다양한 최신 기술을 통합적으로 활용하여 출제 성능을 극대화했습니다. 그 결과, 입시 전문 플랫폼 '오르비'의 유명 강사에게 실제 수능에 출제된 기출 문제 대비 75% 수준의 퀄리티에 도달했다는 평가를 받을 수 있었습니다. 이러한 성과를 바탕으로, 현재 KSAT Agent는 '강남대성학원' 소속의 부설 연구기관 '강남대성수능연구소'와 인수계약 논의 중에 있습니다.</p>
    """, unsafe_allow_html=True)
